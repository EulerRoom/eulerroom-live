...
&#160;<xsl:value-of select="/rtmp/compiler"/>
</body>
</html>
</xsl:template>
...
<tr>
<td colspan="2">Accepted: <xsl:value-of select="naccepted"/>
</td>
...
&#160;<xsl:value-of select="meta/video/profile"/>
...
&#160;<xsl:value-of select="meta/audio/profile"/>
</td>
<td>
<xsl:call-template name="showsize">
...
<td>
<a target="_blank">
<xsl:attribute name="href"> http://apps.db.ripe.net/search/query.html&#63;searchtext=<xsl:value-of select="address"/>
</xsl:attribute>
